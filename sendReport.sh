...
#Sending the email
./sendEmail -f "witkowski.you2.pl@you2.pl" -t $ADMINEMAILS -u "$SUBJECT" -s "smtp.dpoczta.pl:25" -xu "witkowski.you2.pl@you2.pl" -xp "Test1234" -o message-content-type=html -o message-file="./temp/messageBody.html" -o message-charset=utf-8
